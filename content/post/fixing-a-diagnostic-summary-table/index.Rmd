...
# Data
I took the data and put three variants of it into an excel spreadsheet that you can use to follow along. You can download [Kalar 1998.xlsx](https://github.com/MeaghanWetherell/DataVisualizations/blob/main/static/Data/Kalar 1998.xlsx) on Github.<img src="/img/GithubDownloadSmall.png" alt="Github download icon" style="float: right; margin-left: 10px;" width="100"> If you haven't downloaded something from Github before, look for the little download icon on the right hand side of the screen and download the 'raw' file. 
...
```
```{r echo=FALSE}
gtsave(wow, "A Pretty Picture Of a Table.png")
```
